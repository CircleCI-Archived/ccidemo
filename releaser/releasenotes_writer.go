...
const (
	issueLinkTemplate            = "[#%d](https://github.com/circleci/ccidemo/issues/%d)"
	linkTemplate                 = "[%s](%s)"
...
{{ with .Repo -}}
* {{ .Stars }}+ [stars](https://github.com/circleci/ccidemo/stargazers)
* {{ len .Contributors }}+ [contributors](https://github.com/circleci/ccidemo/graphs/contributors)
{{- end -}}
{{ with .ThemeCount }}
