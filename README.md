...
A Fast and Flexible Static Site Generator built with love by [spf13](http://spf13.com/) and [friends](https://github.com/circleci/ccidemo/graphs/contributors) in [Go][].
...
To contribute to the Hugo source code or documentation, you should [fork the Hugo GitHub project](https://github.com/circleci/ccidemo#fork-destination-box) and clone it to your local machine.
...
Add Hugo and its package dependencies to your go `src` directory.
    ...
    go get -v github.com/circleci/ccidemo
...
To update Hugo’s dependencies, use `go get` with the `-u` option.
    ...
    go get -u -v github.com/circleci/ccidemo
	
## The Hugo Documentation

The Hugo documentation now lives in its own repository, see https://github.com/circleci/ccidemoDocs. But we do keep a version of that documentation as a `git subtree` in this repository. To build the sub folder `/docs` as a Hugo site, you need to clone this repo with submodules:
...
The Hugo community and maintainers are [very active](https://github.com/circleci/ccidemo/pulse/monthly) and helpful, and the project benefits greatly from this activity.
