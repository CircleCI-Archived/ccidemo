...
The community-contributed themes featured on [themes.gohugo.io](//themes.gohugo.io/) are hosted in a [centralized GitHub repository][themesrepo]. The Hugo Themes Repo at <https://github.com/circleci/ccidemoThemes> is really a meta repository that contains pointers to a set of contributed themes.
...
```bash
git clone --depth 1 --recursive https://github.com/circleci/ccidemoThemes.git themes
```
...
[themesrepo]: https://github.com/circleci/ccidemoThemes