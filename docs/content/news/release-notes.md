...
See the [full list of closed issues on GitHub](https://github.com/circleci/ccidemo/milestone/16?closed=1).
...
Also, a considerably amount of work have been put into cleaning up the Hugo source code, in an issue titled [Refactor the globals out of site build](https://github.com/circleci/ccidemo/issues/2701). This is not immediately visible to the Hugo end user, but will speed up future development.
...
all of
them](https://github.com/circleci/ccidemoThemes/blob/master/README.md#theme-list).
...
[HugoThemes](https://github.com/circleci/ccidemothemes),
...
This release represents over 90 code commits from 28 different contributors.
  ...
  * 10 [new themes](https://github.com/circleci/ccidemoThemes) created by the community
...
This release represents over 110 code commits from 29 different contributors.
  ...
  * Theme engine w/[Theme Repository](https://github.com/circleci/ccidemoThemes)
