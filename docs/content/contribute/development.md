...
We're going to clone the [master Hugo repository](https://github.com/circleci/ccidemo). That seems counter-intuitive, since you won't have commit rights on it. But it's required for the Go workflow. You'll work on a copy of the master and push your changes to your own repository on GitHub.

So, let's clone that master repository:

```sh
go get -v -u github.com/circleci/ccidemo
```
...
Open the [Hugo repository](https://github.com/circleci/ccidemo) on GitHub and click on the "Fork" button in the top right.
...
```sh
cd $GOPATH/src/github.com/circleci/ccidemo
```
...
origin  https://github.com/circleci/ccidemo (fetch)
origin  https://github.com/circleci/ccidemo (push)
```
...
Once you made your additions commit your changes. Make sure that you follow our [code contribution guidelines](https://github.com/circleci/ccidemo/blob/master/CONTRIBUTING.md):
...
We made a lot of progress. Good work. In this step we finally open a pull request to submit our additions. Open the [Hugo master repository](https://github.com/circleci/ccidemo/) on GitHub in your browser.
...
[contributors]: https://github.com/circleci/ccidemo/graphs/contributors
...
[issues]: https://github.com/circleci/ccidemo/issues
[newissue]: https://github.com/circleci/ccidemo/issues/new
