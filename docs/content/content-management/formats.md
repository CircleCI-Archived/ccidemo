...
{{% warning %}}
Thare are some features not available in Mmark; one example being that shortcodes are not translated when used in an included `.mmark` file ([#3131](https://github.com/circleci/ccidemo/issues/3137)), and `EXTENSION_ABBREVIATION` ([#1970](https://github.com/circleci/ccidemo/issues/1970)) and the aforementioned GFM todo lists ([#2270](https://github.com/circleci/ccidemo/issues/2270)) are not fully supported. Contributions are welcome.
{{% /warning %}}
...
[helperssource]: https://github.com/circleci/ccidemo/blob/77c60a3440806067109347d04eb5368b65ea0fe8/helpers/general.go#L65
