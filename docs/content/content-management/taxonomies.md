...
series = [ "Go Web Dev" ]
slug = "hugo"
project_url = "https://github.com/circleci/ccidemo"
+++
```
...
Currently taxonomies only support the [default `weight => date` ordering of list content](/templates/lists/). For more information, see the documentation on taxonomy templates.
{{% /note %}}
