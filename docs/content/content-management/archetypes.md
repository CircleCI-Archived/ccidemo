...
{{% note %}}
This section is outdated, see https://github.com/circleci/ccidemoDocs/issues/11
{{% /note %}}
{{% todo %}}
See above
{{% /todo %}}
...
You may notice that content files created with `hugo new` do not respect the order of the key-values specified in your archetype files. This is a [known issue](https://github.com/circleci/ccidemo/issues/452).
{{% /note %}}
