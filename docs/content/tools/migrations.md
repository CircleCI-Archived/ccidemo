...
{{% note %}}
Do you know or maintain a similar project around Hugo? Feel free to open a [pull request](https://github.com/circleci/ccidemo/pulls) on GitHub if you think it should be added.
{{% /note %}}
