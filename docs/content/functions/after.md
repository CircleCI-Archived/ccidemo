...
You can use `after` in combination with the [`first` function][] and Hugo's powerful sorting methods. Let's assume you have a list page at `yoursite.com/articles`. You have 10 articles, but you want your templating for the [list/section page][] to show only two rows:
