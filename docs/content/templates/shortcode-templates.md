...
[docsshortcodes]: https://github.com/circleci/ccidemo/tree/master/docs/layouts/shortcodes "See the shortcode source directory for the documentation site you're currently reading."
