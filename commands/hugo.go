...
import (
	...
	"github.com/circleci/ccidemo/hugofs"
	...
	"github.com/circleci/ccidemo/hugolib"
	"github.com/circleci/ccidemo/livereload"
	"github.com/circleci/ccidemo/utils"
	"github.com/circleci/ccidemo/watcher"
...
func (c *commandeer) getDirList() []string {
	...
	walker := func(path string, fi os.FileInfo, err error) error {
		...
		// Related to https://github.com/circleci/ccidemo/issues/3468.
		if fi.Name() == ".git" {
			return nil
		}
